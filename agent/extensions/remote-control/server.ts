...
import { generateSessionId, generateToken, parseCookies, SESSION_COOKIE, validateToken } from "./auth.js";
...
interface WsServer {
  ...
  handleUpgrade(request: IncomingMessage, socket: Socket, head: Buffer, cb: (ws: WsClient) => void): void;
